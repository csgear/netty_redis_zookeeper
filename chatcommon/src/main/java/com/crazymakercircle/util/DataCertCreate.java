...
public class DataCertCreate
{
    ...
    public boolean createPublicKey(String[] info)
    {
        try
        {
            ...
            String string = Base64.encode(cert.getEncoded()).toString();
    ...
    public boolean createPublicKeyBYDecode(String[] info)
    {
        try
        {
            ...
            FileWriter wr = new FileWriter(new File(certPath));
            String encode = Base64.encode(cert.getEncoded()).toString();
